...
## 18. Phase 8 设计：分级阅读 + 反思周期 + 认知冲突

> 待研究完成后补充详细实现设计。

### 18.1 分级阅读（`read --depth quick/standard/deep`）

*[待补充：研究 SuperMemo 增量阅读、Tiago Forte 渐进式摘要后设计]*

### 18.2 反思周期（`reflect` 命令）

*[待补充：研究元认知反思频率、学习日志研究后设计]*

### 18.3 认知冲突实时检测

*[待补充：研究 Piaget 认知失衡、belief revision 后设计]*
